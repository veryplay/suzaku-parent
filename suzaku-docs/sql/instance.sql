...
create table if not exists instance(
    ...
    name varchar(64) comment '实例名称',
    hostname varchar(128) comment '主机名',
    image_id varchar(36) not null comment '镜像UUID',
    root_volume_raid_level varchar(12) comment '系统盘raid',
    data_volume_raid_level varchar(12) comment '数据盘raid',
